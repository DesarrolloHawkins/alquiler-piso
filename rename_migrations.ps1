...
$migrations1Digit = @(
    ...
    "02_create_password_reset_tokens_table.php",
    "03_create_password_resets_table.php",
    "04_create_failed_jobs_table.php",
...
foreach ($migration in $migrations1Digit) {
...
foreach ($migration in $migrations2Digits) {
    if (Test-Path $migration) {
