...
class OllamaProxyController extends Controller
{
    private $ollamaConfig = [
        'base_url' => 'https://192.168.1.45/chat',
    ...
    public function health(): JsonResponse
    {
        try {
            $response = Http::withOptions([
                'verify' => false, // Ignorar certificado SSL
                'timeout' => 10
            ])->withHeaders([
        ...
        try {
            ...
            if ($request->hasFile('image')) {
                ...
                curl_setopt_array($curl, [
                    ...
                    CURLOPT_SSL_VERIFYPEER => false,  // Ignorar SSL como tu curl -k
                    CURLOPT_SSL_VERIFYHOST => false   // Ignorar SSL como tu curl -k
                ]);
