        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Laravel') }}<sup style="font-size: 9px; font-weight: 400; color: #adb5bd; letter-spacing: 0; margin-left: 3px;">v0.1</sup>
                </a>
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{route('clientes.index')}}">Ver todos</a></li>
