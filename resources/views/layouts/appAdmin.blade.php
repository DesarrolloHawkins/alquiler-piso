                    ...
                    <div class="col-auto bg-light sidebar p-3" 
                        ...
                        <div class="d-flex flex-column flex-shrink-0 text-white h-100" style="">
                            ...
                            <ul class="nav nav-pills flex-row mb-auto" style="overflow-x: none; overflow:auto;">
                                ...
                                <li class="nav-item w-100">
                                    <!-- Modificado para mantener abierto cuando esté dentro de las rutas relacionadas -->
                                    <button data-bs-target="#submenuTesoreria" href="#submenuTesoreria" data-info="button" class="nav-link fs-5 w-100 text-start {{ request()->is('diario-caja', 'diario-caja/*', 'ingresos', 'ingresos/*','facturas', 'facturas/*', 'categoria-ingresos', 'categoria-ingresos/*', 'gastos', 'gastos/*','bancos', 'bancos/*','categoria-gastos', 'categoria-gastos/*') ? 'active' : 'collapsed' }}" aria-expanded="{{ request()->is('diario-caja', 'diario-caja/*', 'ingresos', 'ingresos/*', 'categoria-ingresos', 'categoria-ingresos/*', 'gastos', 'gastos/*','bancos', 'bancos/*','categoria-gastos', 'categoria-gastos/*') ? 'true' : 'false' }}">
