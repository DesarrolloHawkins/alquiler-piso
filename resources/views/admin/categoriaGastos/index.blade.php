...
<div class="container-fluid">
    <h2 class="mb-3">{{ __('Nuestras Categoria de Gastos') }}</h2>
    <a href="{{route('admin.categoriaGastos.create')}}" class="btn bg-color-quinto">Crear categoria</a>
    <hr class="mb-5">
                ...
                <tbody>
                    @foreach ($categorias as $categoria)
                        <tr>
                            ...
                            <td style="width:auto;">
                                <a href="{{route('admin.categoriaGastos.edit', $categoria->id)}}" class="btn btn-secundario">Editar</a>
                                <form action="{{ route('admin.categoriaGastos.destroy', $categoria->id) }}" method="POST" style="display: inline;" class="delete-form">
                                    @csrf
