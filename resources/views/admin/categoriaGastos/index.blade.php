...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Administra las categorías para clasificar los gastos</p>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Categorías de Gastos</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-0 fw-semibold text-dark">
                        <i class="fas fa-plus me-2 text-danger"></i>
                        Gestión de Categorías
                    </h5>
                    <p class="text-muted mb-0">Crea y gestiona las categorías de gastos</p>
                </div>
                <a href="{{ route('admin.categoriaGastos.create') }}" class="btn btn-danger btn-lg">
    ...
    <div class="card shadow-sm border-0 mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.categoriaGastos.index') }}" method="GET">
                    ...
                    <thead class="table-light">
                        <tr>
                            <th scope="col" class="border-0">
                                <a href="{{ route('admin.categoriaGastos.index', ['sort' => 'id', 'order' => request('order', 'asc') == 'asc' ? 'desc' : 'asc', 'search' => request('search')]) }}"
                            ...
                            <th scope="col" class="border-0">
                                <a href="{{ route('admin.categoriaGastos.index', ['sort' => 'nombre', 'order' => request('order', 'asc') == 'asc' ? 'desc' : 'asc', 'search' => request('search')]) }}"
                                   class="text-decoration-none text-dark fw-semibold">
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                <div class="btn-group" role="group">
                                    <a href="{{route('admin.categoriaGastos.edit', $categoria->id)}}" 
                                       class="btn btn-outline-warning btn-sm" 
                                       title="Editar categoría">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('admin.categoriaGastos.destroy', $categoria->id) }}" 
                                          method="POST" 
