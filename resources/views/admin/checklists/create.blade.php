...
<div class="container-fluid">
    <h2 class="mb-3">{{ __('Crear Categoria de Limpieza') }}</h2>
    <hr class="mb-5">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form action="{{ route('admin.checklists.store') }}" method="POST" class="mb-4">
              @csrf
              ...
              <div id="photo-requirements">
                  <!-- No se cargan fotos por defecto -->
              </div>
              <button type="button" id="add-photo-requirement" class="btn btn-secondary mb-4 d-block">Añadir Foto</button> --}}

              <button type="submit" class="btn bg-color-primero d-block">Crear Categoria</button>
            </form>
        </div>
    </div>
</div>
