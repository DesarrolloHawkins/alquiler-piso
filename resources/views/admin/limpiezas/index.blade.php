                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        {{ $limpiezas->where('created_at', '>=', now()->startOfDay())->count() }}
                                    </div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        {{ $limpiezas->where('tipo_limpieza', 'zona_comun')->where('created_at', '>=', now()->startOfDay())->count() }}
                                    </div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        {{ $limpiezas->where('created_at', '>=', now()->startOfDay())->where('status_id', 3)->count() }}
                                    </div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        {{ $limpiezas->where('consentimiento_finalizacion', true)->count() }}
                                    </div>
                                </div>
                                <div class="col-auto">
                                ...
                                <tbody>
                                    @foreach($limpiezas as $limpieza)
                                        <tr class="@if($limpieza->zonaComun) zona-comun-row @elseif($limpieza->apartamento) apartamento-row @endif" 
                                            ...
                                            <td>
                                                @php
                                                    // Contar fotos desde ApartamentoLimpiezaItem (donde realmente están)
                                                    $totalFotos = \App\Models\ApartamentoLimpiezaItem::where('id_limpieza', $limpieza->id)
